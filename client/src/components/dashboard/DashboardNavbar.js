          ...
          <nav class="blue-grey" role="navigation">
            <div class="nav-wrapper container">
              <ul class="left hide-on-med-and-down">
                <li>
                  <a class="dropdown-trigger" data-target="main-dropdown1">
                    My Business
                  </a>
                </li>
                <li>
                  <a class="dropdown-trigger" data-target="main-dropdown2">
                    Contact Management
                  </a>
                </li>
              </ul>
              <ul class="right hide-on-med-and-down">
                ...
                <li>
                  <a class="dropdown-trigger" data-target="main-dropdown3">
